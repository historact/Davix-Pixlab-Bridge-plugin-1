...
2. Activate PixLab License Bridge; activation runs DB migrations and fails if dependencies are missing.
3. Visit **PixLab License → Settings** to configure:
   - Node Base URL.
   - Bridge token.
...
- File logging writes to Pixlab License Bridge Logs in `wp-content/uploads/pixlab-license-bridge-logs/` and needs filesystem permissions.
