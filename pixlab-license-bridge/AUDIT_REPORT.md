# PixLab License Bridge – Technical Audit

## 1) Inventory (files & purposes)
- **pixlab-license-bridge.php** – Loader defining constants, includes core classes, registers activation/uninstall hooks, and boots the plugin on `plugins_loaded`.
