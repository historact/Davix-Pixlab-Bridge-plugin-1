...
class DSB_Dashboard {
        ...
        wp_localize_script(
            ...
            [
                ...
                'strings'      => [
                    ...
                    'error'         => __( 'Unable to load dashboard right now.', 'pixlab-license-bridge' ),
                    'copied'        => __( 'Copied to clipboard.', 'pixlab-license-bridge' ),
                    'copyFailed'    => __( 'Copy failed.', 'pixlab-license-bridge' ),
                    'confirmRotate' => __( 'Are you sure you want to regenerate your API key?', 'pixlab-license-bridge' ),
                    'rotateError'   => __( 'Unable to regenerate key.', 'pixlab-license-bridge' ),
                    'shownOnce'     => $labels['label_modal_hint'],
                    'toggleOn'      => $labels['label_enable_key'],
                    'toggleOff'     => $labels['label_disable_key'],
                    'toggleError'   => __( 'Unable to update key.', 'pixlab-license-bridge' ),
                    'toastSuccess'  => __( 'Updated', 'pixlab-license-bridge' ),
                    'provisioning'  => $labels['dsb_label_provisioning'],
                    'provisioningFailed' => __( 'Provisioning failed. Please contact support.', 'pixlab-license-bridge' ),
                    'provisioningNext'   => __( 'Next retry:', 'pixlab-license-bridge' ),
                ],
            ]
        );
    ...
    protected function build_style_attribute( array $styles ): string {
        ...
        $map = [
            ...
            '--dsb-card-text'                 => 'style_cards_text',
            ...
            '--dsb-card-bg'                   => 'style_cards_bg',
            '--dsb-card-border'               => 'style_cards_border',
            '--dsb-card-shadow'               => 'style_cards_shadow_color',
            ...
            '--dsb-btn-primary-bg'            => 'style_btn_primary_normal_bg',
            '--dsb-btn-primary-text'          => 'style_btn_primary_normal_text',
            '--dsb-btn-primary-border'        => 'style_btn_primary_normal_border',
            ...
            '--dsb-btn-primary-active-bg'     => 'style_btn_primary_active_bg',
            '--dsb-btn-primary-active-text'   => 'style_btn_primary_active_text',
            '--dsb-btn-primary-active-border' => 'style_btn_primary_active_border',
            ...
            '--dsb-btn-outline-bg'            => 'style_btn_outline_normal_bg',
            '--dsb-btn-outline-text'          => 'style_btn_outline_normal_text',
            '--dsb-btn-outline-border'        => 'style_btn_outline_normal_border',
            ...
            '--dsb-btn-ghost-active-bg'       => 'style_btn_ghost_active_bg',
            '--dsb-btn-ghost-active-text'     => 'style_btn_ghost_active_text',
            '--dsb-btn-ghost-active-border'   => 'style_btn_ghost_active_border',
            ...
            '--dsb-status-active-bg'          => 'style_status_active_bg',
            '--dsb-status-active-border'      => 'style_status_active_border',
            '--dsb-status-active-text'        => 'style_status_active_text',
            '--dsb-status-disabled-bg'        => 'style_status_disabled_bg',
            '--dsb-status-disabled-border'    => 'style_status_disabled_border',
            '--dsb-status-disabled-text'      => 'style_status_disabled_text',
