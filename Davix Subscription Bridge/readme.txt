...
== Description ==
Davix Subscription Bridge securely sends subscription lifecycle events from WooCommerce + WPSwings "Subscriptions for WooCommerce" to a Davix Pixlab Node.js API. It supports activation, renewals, cancellation, expiration, and payment failure signals, with on-demand key provisioning/rotation via protected Node admin endpoints.
...
3. Go to **Davix Bridge → Settings** and set your Node Base URL and Bridge Token. Enable logging if desired.
