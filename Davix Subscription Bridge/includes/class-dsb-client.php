...
class DSB_Client {
    ...
    public function get_label_defaults(): array {
        return [
            ...
            'dsb_label_enabled'           => __( 'Enabled', 'davix-sub-bridge' ),
            'dsb_label_disabled'          => __( 'Disabled', 'davix-sub-bridge' ),
            'dsb_label_provisioning'      => __( 'Provisioning...', 'davix-sub-bridge' ),
            'dsb_label_expired_message'   => __( 'Your API key is expired. Please renew to enable.', 'davix-sub-bridge' ),
