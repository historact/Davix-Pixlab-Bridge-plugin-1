    ...
    protected function render_style_tab(): void {
        ...
        <form method="post" class="dsb-style-form">
            ...
            <div class="dsb-style-save-bar">
                <?php submit_button( __( 'Save Changes', 'davix-sub-bridge' ), 'primary', 'submit', false ); ?>
            </div>
            ...
            <div class="dsb-style-section">
                <h3><?php esc_html_e( 'Modal & Overlay', 'davix-sub-bridge' ); ?></h3>
                <p class="description"><?php esc_html_e( 'Control overlay color for modal dialogs in the dashboard.', 'davix-sub-bridge' ); ?></p>
                <table class="form-table" role="presentation">
                    <?php
                    $this->render_color_input_field( 'style_overlay_color', __( 'Modal Overlay Color', 'davix-sub-bridge' ), $styles['style_overlay_color'], __( 'Backdrop color behind modals.', 'davix-sub-bridge' ) );
                    ?>
                </table>
            </div>

            <div class="dsb-style-section">
                <h3><?php esc_html_e( 'Layout Sizes & Spacing', 'davix-sub-bridge' ); ?></h3>
                <p class="description"><?php esc_html_e( 'Tune radii, padding, and shadow depth for dashboard cards.', 'davix-sub-bridge' ); ?></p>
                <table class="form-table" role="presentation">
                    <?php
                    $this->render_number_input_field( 'style_card_radius', __( 'Card & Container Radius', 'davix-sub-bridge' ), $styles['style_card_radius'], __( 'Corner radius (px) for cards and the dashboard container.', 'davix-sub-bridge' ), 1, 0, 48 );
                    $this->render_number_input_field( 'style_card_shadow_blur', __( 'Card Shadow Blur', 'davix-sub-bridge' ), $styles['style_card_shadow_blur'], __( 'Blur radius (px) for card shadows.', 'davix-sub-bridge' ), 1, 0, 64 );
                    $this->render_number_input_field( 'style_card_shadow_spread', __( 'Card Shadow Spread', 'davix-sub-bridge' ), $styles['style_card_shadow_spread'], __( 'Shadow spread (px) for cards.', 'davix-sub-bridge' ), 1, -10, 30 );
                    $this->render_number_input_field( 'style_container_padding', __( 'Dashboard Padding', 'davix-sub-bridge' ), $styles['style_container_padding'], __( 'Padding (px) inside the dashboard wrapper.', 'davix-sub-bridge' ), 1, 0, 80 );
                    ?>
                </table>
            </div>
            ...
            <div class="dsb-style-section">
                ...
                <table class="form-table" role="presentation">
                    ...
                    $this->render_text_input_field( 'dsb_label_enabled', __( 'Status Badge: Enabled', 'davix-sub-bridge' ), $labels['dsb_label_enabled'], __( 'Status label shown when the key is active.', 'davix-sub-bridge' ) );
                    $this->render_text_input_field( 'dsb_label_disabled', __( 'Status Badge: Disabled', 'davix-sub-bridge' ), $labels['dsb_label_disabled'], __( 'Status label shown when the key is disabled or expired.', 'davix-sub-bridge' ) );
                    $this->render_text_input_field( 'dsb_label_provisioning', __( 'Status Badge: Provisioning', 'davix-sub-bridge' ), $labels['dsb_label_provisioning'], __( 'Status label shown while a key is provisioning.', 'davix-sub-bridge' ) );
                    $this->render_text_input_field( 'dsb_label_expired_message', __( 'Expired Key Message', 'davix-sub-bridge' ), $labels['dsb_label_expired_message'], __( 'Message shown when enabling is blocked due to an expired subscription.', 'davix-sub-bridge' ) );
                    ...
                    $this->render_text_input_field( 'label_action', __( 'Table Header: “Action”', 'davix-sub-bridge' ), $labels['label_action'], __( 'Header label for the Action column in history.', 'davix-sub-bridge' ) );
                ...
                <table class="form-table" role="presentation">
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="enable_purge_worker" value="1" <?php checked( ! empty( $settings['enable_purge_worker'] ) ); ?> /> <?php esc_html_e( 'Process purge queue automatically', 'davix-sub-bridge' ); ?></label>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="form-table" role="presentation">
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="enable_node_poll_sync" value="1" <?php checked( $settings['enable_node_poll_sync'], 1 ); ?> /> <?php esc_html_e( 'Fetch truth from Node export on a schedule.', 'davix-sub-bridge' ); ?></label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="node_poll_delete_stale" value="1" <?php checked( $settings['node_poll_delete_stale'], 1 ); ?> /> <?php esc_html_e( 'Remove davix_bridge keys/users missing from Node export.', 'davix-sub-bridge' ); ?></label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="enable_cron_debug_node_poll" value="1" <?php checked( ! empty( $settings['enable_cron_debug_node_poll'] ) ); ?> /> <?php esc_html_e( 'Enable Node poll cron debug log', 'davix-sub-bridge' ); ?></label>
                        </td>
                    </tr>
                </table>
                ...
                <table class="form-table" role="presentation">
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="enable_daily_resync" value="1" <?php checked( $settings['enable_daily_resync'], 1 ); ?> /> <?php esc_html_e( 'Fetch WPS subscriptions daily and reconcile Node.', 'davix-sub-bridge' ); ?></label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="resync_disable_non_active" value="1" <?php checked( $settings['resync_disable_non_active'], 1 ); ?> /> <?php esc_html_e( 'Send disable events for cancelled/expired/paused/payment_failed.', 'davix-sub-bridge' ); ?></label>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><?php esc_html_e( 'Alerts', 'davix-sub-bridge' ); ?></th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="enable_cron_debug_resync" value="1" <?php checked( ! empty( $settings['enable_cron_debug_resync'] ) ); ?> /> <?php esc_html_e( 'Enable resync cron debug log', 'davix-sub-bridge' ); ?></label>
                        </td>
                    </tr>
                </table>
