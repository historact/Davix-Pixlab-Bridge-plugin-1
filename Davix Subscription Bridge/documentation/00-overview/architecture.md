...
Davix Subscription Bridge synchronizes WooCommerce + WPSwings subscription lifecycle data with the Davix Node service.

## Components
- **Bootstrap**: `Davix Subscription Bridge.php` defines constants and instantiates `DSB_Plugin` on `plugins_loaded`.
